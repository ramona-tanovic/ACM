...
run_recovery_multilevel <- function(mod, S = 40, Ts = c(30, 60, 120), seed = 1) {
  ...
  ggsave("outputs/figs/fig6_recovery_multilevel.png", p, width = 11, height = 6, dpi = 200)
  ...
  ggsave("outputs/figs/fig7_recovery_multilevel_coverage.png", p_cov, width = 9, height = 4.8, dpi = 200)
}
