...
make_single_agent_checks <- function(mod, fit, sim) {
  ...
  ggsave("outputs/figs/fig0_prior_post_pred_repeat_rate.png", p1, width = 8, height = 5, dpi = 200)
  ...
  ggsave("outputs/figs/fig1_prior_posterior_update.png", p2, width = 9, height = 4.5, dpi = 200)
