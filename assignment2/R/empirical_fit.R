...
source("R/recovery_multilevel.R")  # for prep_transitions() and fit_wsls_hier()
...
run_empirical_fit <- function(mod) {
  ...
  ggsave("outputs/figs/fig8_empirical_ppc_repeat_rate.png", p1, width = 8, height = 5, dpi = 200)
